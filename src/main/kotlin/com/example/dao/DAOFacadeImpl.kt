...
import com.example.database.Articles
...
class DAOFacadeImpl: DAOFacade {
    ...
    override suspend fun editArticle(id: Int, title: String, body: String): Boolean = true
//        dbQuery {
...
//    }
    ...
    override suspend fun deleteArticle(id: Int): Boolean = true
//    dbQuery {
